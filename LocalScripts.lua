...
local BG      = Color3.fromRGB(160, 40, 40)
local SURFACE = Color3.fromRGB(140, 35, 35)
local ACCENT  = Color3.fromRGB(100, 150, 255)
local BORDER  = Color3.fromRGB(100, 150, 255)
local TEXT    = Color3.fromRGB(230,230,240)
local SUBTEXT = Color3.fromRGB(200,180,200)
local ITEMHOV = Color3.fromRGB(120, 45, 45)
local ITEMSEL = Color3.fromRGB(70, 120, 200)
    ...
    if swapModel and oldSlot then
        ...
        if mSpawn2 then
            ...
            pcall(function()
                ...
                slotPromptConns[oldSlot] = {}
                modelPromptInfo[swapModel] = {att = att, slot = oldSlot}
                local swapSlot = oldSlot
                for _, p in att:GetChildren() do
                    if p:IsA("ProximityPrompt") then
                        if p.KeyboardKeyCode == Enum.KeyCode.E then
...
local function _refreshScale()
    pcall(function()
        ...
        _kvScale.Scale = math.clamp(s, 0.7, 1.3)
    end)
end
_refreshScale()
pcall(function()
...
Corner(win, 8)
Stroke(win, Color3.fromRGB(100,150,255), 1, 0.2)
...
Corner(tbar, 8)
New("Frame", {Size=UDim2.new(1,0,0.5,0), Position=UDim2.new(0,0,0.5,0), BackgroundColor3=SURFACE, BorderSizePixel=0, Parent=tbar})
New("TextLabel", {
    Size=UDim2.new(1,-20,1,0), Position=UDim2.new(0,10,0,0),
    Text="skidded trade script",
    TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamSemibold,
    TextSize=12, BackgroundTransparency=1,
...
local tabBar = New("Frame", {
    Size=UDim2.new(1,0,0,34), BackgroundColor3=BG,
...
do
    local selectedHeader = New("Frame", {
        Size=UDim2.new(1,0,0,50), BackgroundColor3=SURFACE,
        BorderSizePixel=0, LayoutOrder=1, Parent=brainrotsPage,
    })
    Corner(selectedHeader, 6)
    Stroke(selectedHeader, Color3.fromRGB(100,150,255), 1, 0.2)
    local rarityTag = New("TextLabel", {
        ...
        TextSize=11, TextXAlignment=Enum.TextXAlignment.Left, Parent=selectedHeader,
    })
    local selectedName = New("TextLabel", {
        ...
        TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamBold,
        TextSize=16, TextXAlignment=Enum.TextXAlignment.Left, Parent=selectedHeader,
    })
    local selectedPrice = New("TextLabel", {
        ...
        TextSize=16, TextXAlignment=Enum.TextXAlignment.Right, Parent=selectedHeader,
    })
    ...
    local animalToggleBtn = New("TextButton", {
        Size=UDim2.new(1,0,0,32), BackgroundColor3=SURFACE,
        BorderSizePixel=0, Text="▼  Select Animal",
        TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamBold,
        TextSize=14, AutoButtonColor=false, LayoutOrder=2, Parent=brainrotsPage,
    })
    Corner(animalToggleBtn, 6)
    Stroke(animalToggleBtn, Color3.fromRGB(100,150,255), 1, 0.2)
    animalToggleBtn.MouseEnter:Connect(function() animalToggleBtn.BackgroundColor3=ITEMHOV end)
    animalToggleBtn.MouseLeave:Connect(function() animalToggleBtn.BackgroundColor3=SURFACE end)
    ...
    Stroke(listContainer, Color3.fromRGB(100,150,255), 1, 0.2)
    ...
    local multiToggle = New("TextButton", {
        ...
        TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamBold,
        TextSize=12, AutoButtonColor=false, BorderSizePixel=0, Parent=listContainer,
    })
    ...
    Corner(searchRow, 6)
    Stroke(searchRow, Color3.fromRGB(100,150,255), 1, 0.2)
    ...
    Corner(listFrame, 6)
    Stroke(listFrame, Color3.fromRGB(100,150,255), 1, 0.3)
    do
            ...
            for _,name in ipairs(group.names) do
                if filter=="" or name:lower():find(filter,1,true) then
                    ...
                    b.MouseEnter:Connect(function()
                        if _multiSelectMode then
                            if not _multiSelected[name] then b.BackgroundColor3 = ITEMHOV end
                        else
                            if selectedAnimal ~= name then b.BackgroundColor3 = ITEMHOV end
                        end
                    end)
    ...
    local traitsBtn = New("TextButton", {
        ...
        TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamBold,
        TextSize=14, AutoButtonColor=false, LayoutOrder=4, Parent=brainrotsPage,
    })
    Corner(traitsBtn, 6)
    Stroke(traitsBtn, Color3.fromRGB(100,150,255), 1, 0.2)
    traitsBtn.MouseEnter:Connect(function() traitsBtn.BackgroundColor3=ITEMHOV end)
    traitsBtn.MouseLeave:Connect(function() traitsBtn.BackgroundColor3=SURFACE end)
    local tmBtn = traitsBtn

    local spawnCount = 1
    local qtyRow = New("Frame", {
        Size=UDim2.new(1,0,0,34), BackgroundColor3=SURFACE,
        BorderSizePixel=0, LayoutOrder=8, Parent=brainrotsPage,
    })
    Corner(qtyRow, 6)
    Stroke(qtyRow, Color3.fromRGB(100,150,255), 1, 0.3)
    ...
    local spawnBtn = New("TextButton", {
        ...
        TextSize=16, AutoButtonColor=false, LayoutOrder=9, Parent=brainrotsPage,
    })
    Corner(spawnBtn, 6)
    ...
    local statusLbl = New("TextLabel", {Size=UDim2.new(1,0,0,0), BackgroundTransparency=1, Text="", TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamBold, TextSize=12, TextXAlignment=Enum.TextXAlignment.Center, Parent=brainrotsPage, Visible=false})
    local countLbl = New("TextLabel", {Size=UDim2.new(1,0,0,0), BackgroundTransparency=1, Text="", TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamSemibold, TextSize=12, TextXAlignment=Enum.TextXAlignment.Center, Parent=brainrotsPage, Visible=false})
    ...
    Corner(tmPopup, 6)
    Stroke(tmPopup, Color3.fromRGB(100,150,255), 1, 0.2)
    ...
    for _,trait in ipairs(TRAITS) do
        ...
        traitBtns[trait] = b
        b.MouseEnter:Connect(function()
            if not selectedTraits[trait] then b.BackgroundColor3 = ITEMHOV end
        end)
    ...
    local mutationsBtn = New("TextButton", {
        ...
        TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamBold,
        TextSize=14, AutoButtonColor=false, LayoutOrder=6, Parent=brainrotsPage,
    })
    Corner(mutationsBtn, 6)
    Stroke(mutationsBtn, Color3.fromRGB(100,150,255), 1, 0.2)
    mutationsBtn.MouseEnter:Connect(function() mutationsBtn.BackgroundColor3=ITEMHOV end)
    mutationsBtn.MouseLeave:Connect(function() mutationsBtn.BackgroundColor3=SURFACE end)
    ...
    Corner(mutPopup, 6)
    Stroke(mutPopup, Color3.fromRGB(100,150,255), 1, 0.2)
    ...
    for _,mut in ipairs(MUTATIONS) do
        ...
        mutBtns[mut] = b
        b.MouseEnter:Connect(function()
            if selectedMutation ~= mut then b.BackgroundColor3 = ITEMHOV end
        end)
        b.MouseLeave:Connect(function()
    ...
    do
        ...
        Stroke(skinToggleBtn, Color3.fromRGB(100,150,255), 1, 0.2)
        skinToggleBtn.MouseEnter:Connect(function() skinToggleBtn.BackgroundColor3=ITEMHOV end)
        skinToggleBtn.MouseLeave:Connect(function() skinToggleBtn.BackgroundColor3=SURFACE end)
        ...
        Stroke(skinListPanel, Color3.fromRGB(100,150,255), 1, 0.2)
        ...
        Stroke(skinListFrame, Color3.fromRGB(100,150,255), 1, 0.3)
        do
        ...
        local function BuildSkinList()
            ...
            for _, skin in ipairs(available) do
                ...
                b.MouseEnter:Connect(function()
                    if _selectedSkin ~= skin.name then b.BackgroundColor3=ITEMHOV end
                end)
                b.MouseLeave:Connect(function()
    ...
    do
        local function MakeMiscSection(title, layoutOrder, openByDefault)
            ...
            Corner(hdrBtn, 6); Stroke(hdrBtn, Color3.fromRGB(100,150,255), 1, 0.2)
            local arrowLbl = New("TextLabel", {
                Size=UDim2.new(1,-20,1,0), Position=UDim2.new(0,10,0,0),
                BackgroundTransparency=1, Text=(openByDefault and "▼  " or "▶  ") .. title,
                TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamBold,
                TextSize=13, TextXAlignment=Enum.TextXAlignment.Left, Parent=hdrBtn,
            })
        ...
        local row = New("Frame", {
            Size=UDim2.new(1,0,0,42), BackgroundColor3=SURFACE,
            BorderSizePixel=0, LayoutOrder=1, Parent=cfgContent,
        })
        Corner(row, 6); Stroke(row, Color3.fromRGB(100,150,255), 1, 0.3)
        New("TextLabel", {
        ...
        Corner(row2, 6); Stroke(row2, Color3.fromRGB(100,150,255), 1, 0.3)
        New("TextLabel", {
            Size=UDim2.new(0.7,-10,1,0), Position=UDim2.new(0,10,0,0),
            BackgroundTransparency=1,
        ...
        local saveToggleBtn = New("TextButton", {
            ...
            TextColor3=Color3.fromRGB(255,255,255),
            Font=Enum.Font.GothamBold, TextSize=13, Parent=row2,
        })
        ...
        Corner(row3b, 6); Stroke(row3b, Color3.fromRGB(100,150,255), 1, 0.3)
        New("TextLabel", {
            Size=UDim2.new(0.7,-10,1,0), Position=UDim2.new(0,10,0,0),
            BackgroundTransparency=1,
        ...
        local hideToggleBtn = New("TextButton", {
            ...
            TextColor3=Color3.fromRGB(255,255,255),
            Font=Enum.Font.GothamBold, TextSize=13, Parent=row3b,
        })
        ...
        do
            ...
            Corner(row4, 6); Stroke(row4, Color3.fromRGB(100,150,255), 1, 0.3)
            New("TextLabel", {
            ...
            local keyBtn = New("TextButton", {
                ...
                TextColor3=Color3.fromRGB(255,255,255),
                Font=Enum.Font.GothamBold, TextSize=13, Parent=row4,
            })
            Corner(keyBtn, 5)
        ...
        do
            ...
            Corner(row5, 6); Stroke(row5, Color3.fromRGB(100,150,255), 1, 0.3)
            New("TextLabel", {
                Size=UDim2.new(0.6,-10,1,0), Position=UDim2.new(0,10,0,0),
                BackgroundTransparency=1,
                Text="Rejoin Key",
            ...
            local rejoinBtn = New("TextButton", {
                ...
                TextColor3=Color3.fromRGB(255,255,255),
                Font=Enum.Font.GothamBold, TextSize=13, Parent=row5,
            })
            Corner(rejoinBtn, 5)
        ...
        do
            ...
            Corner(row6, 6); Stroke(row6, Color3.fromRGB(100,150,255), 1, 0.3)
            New("TextLabel", {
                Size=UDim2.new(0.6,-10,1,0), Position=UDim2.new(0,10,0,0),
                BackgroundTransparency=1,
                Text="Dupe Item Key",
            ...
            local dupeKeyBtn = New("TextButton", {
                ...
                TextColor3=Color3.fromRGB(255,255,255),
                Font=Enum.Font.GothamBold, TextSize=13, Parent=row6,
            })
            Corner(dupeKeyBtn, 5)
        ...
        do
            ...
            Corner(row7, 6); Stroke(row7, Color3.fromRGB(100,150,255), 1, 0.3)
            New("TextLabel", {
                Size=UDim2.new(0.6,-10,1,0), Position=UDim2.new(0,10,0,0),
                BackgroundTransparency=1,
            ...
            local afKeyBtn = New("TextButton", {
                ...
                TextColor3=Color3.fromRGB(255,255,255),
                Font=Enum.Font.GothamBold, TextSize=13, Parent=row7,
            })
            Corner(afKeyBtn, 5)
        ...
        do
            ...
            Corner(row8, 6); Stroke(row8, Color3.fromRGB(100,150,255), 1, 0.3)
            New("TextLabel", {
                Size=UDim2.new(0.6,-10,1,0), Position=UDim2.new(0,10,0,0),
            ...
            local tnKeyBtn = New("TextButton", {
                ...
                TextColor3=Color3.fromRGB(255,255,255),
                Font=Enum.Font.GothamBold, TextSize=13, Parent=row8,
            })
            Corner(tnKeyBtn, 5)
    ...
    do
        ...
        function _openSignEditor()
            ...
            Corner(panel, 8); Stroke(panel, Color3.fromRGB(100,150,255), 1, 0.2)
            MakeDraggable(panel)
            New("TextLabel", {
            ...
            local closeBtn = New("TextButton", {
                ...
                TextSize = 14, AutoButtonColor = false, BorderSizePixel = 0, Parent = panel,
            })
            Corner(closeBtn, 4)
            ...
            Corner(manualBox, 5); Stroke(manualBox, Color3.fromRGB(100,150,255), 1, 0.2)
            ...
            local randToggle = New("TextButton", {
                ...
                TextColor3 = Color3.fromRGB(255,255,255),
                Font = Enum.Font.GothamBold, TextSize = 13, Parent = randomRow,
            })
            Corner(randToggle, 5)
            ...
            Corner(cycleBox, 5); Stroke(cycleBox, Color3.fromRGB(100,150,255), 1, 0.2)
            New("TextLabel", {
            ...
            Corner(listBox, 5); Stroke(listBox, Color3.fromRGB(100,150,255), 1, 0.2)
            ...
            saveBtn.MouseLeave:Connect(function() saveBtn.BackgroundColor3 = BTNGRN end)
        ...
        OpenFakeTradeSetup = function(prefill)
            ...
            fakeTradeWin = win2
            Corner(win2, 6)
            Stroke(win2, Color3.fromRGB(100,150,255), 1, 0.2)
            local popSg = nil
            ...
            local function refreshIgnoreBtn()
                ...
                ignoreBtn.BackgroundColor3 = ignoreHide
                    and BTNGRN or Color3.fromRGB(80,80,90)
            end
            ...
            New("TextLabel", {
                ...
                TextColor3=Color3.fromRGB(230,230,240), Font=Enum.Font.GothamBold,
                TextSize=11, TextXAlignment=Enum.TextXAlignment.Left, Parent=win2,
            })
            y = y + 16
            local usernameBox = New("TextBox", {
                ...
                TextSize=15, ClearTextOnFocus=false, BorderSizePixel=0, Parent=win2,
            })
            Corner(usernameBox, 5)
            Stroke(usernameBox, Color3.fromRGB(100,150,255), 1, 0.2)
            if prefill and type(prefill.username) == "string" and prefill.username ~= "" then
            ...
            Corner(animalBtn, 6)
            Stroke(animalBtn, Color3.fromRGB(100,150,255), 1, 0.2)
            ...
            Corner(mutBtn, 6)
            Stroke(mutBtn, Color3.fromRGB(100,150,255), 1, 0.2)
            local function MakeDD(btn, items, cb, withImages, iconTable)
                ...
                btn.Activated:Connect(function()
                    ...
                    Corner(dd,6); Stroke(dd,Color3.fromRGB(100,150,255),1,0.2)
                    ...
                    for ii,it in ipairs(items) do
                        ...
                        r.MouseEnter:Connect(function() r.BackgroundColor3=ITEMHOV end)
            ...
            local addBtn = New("TextButton", {
                ...
                BackgroundColor3=BTNGRN, Text="+ ADD",
                TextColor3=Color3.fromRGB(255,255,255), Font=Enum.Font.GothamBold,
            ...
            local launchBtn = New("TextButton", {
                ...
                TextColor3=Color3.fromRGB(255,255,255), Font=Enum.Font.GothamBold,
                TextSize=16, AutoButtonColor=false, BorderSizePixel=0, Parent=win2,
            })
            Corner(launchBtn, 6)
            ...
            local forceBtn = New("TextButton", {
                Size=UDim2.new(1,-pad*2,0,32), Position=UDim2.new(0,pad,0,y),
                BackgroundColor3=BTNGRN, Text="Force Accept",
                TextColor3=Color3.fromRGB(255,255,255), Font=Enum.Font.GothamBold,
                TextSize=14, AutoButtonColor=false, BorderSizePixel=0, Parent=win2,
            })
            Corner(forceBtn, 6)
            forceBtn.MouseEnter:Connect(function() forceBtn.BackgroundColor3=Color3.fromRGB(60,180,90) end)
            forceBtn.MouseLeave:Connect(function() forceBtn.BackgroundColor3=BTNGRN end)
